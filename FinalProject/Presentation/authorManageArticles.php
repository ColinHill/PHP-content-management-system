...
<form action="authorUpdateArticles.php" method="post" name="updateArticles" onsubmit="validateForm15()">
    <p>ID to Update:
...
<form action="authorCreateArticles.php" method="post" name="createArticles">
    <p>
